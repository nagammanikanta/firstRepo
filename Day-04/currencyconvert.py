...
"(BalearicIslands),Belgium,CanaryIslands,Cyprus,Finland,France,FrenchGuiana,FrenchSouthernTerritories,Germany,Greece,Guadeloupe,Holland(Netherlands),HolySee,(VaticanCity),Ireland(Eire),Italy,Luxembourg,MadeiraIslands,Malta,Monaco,Montenegro,Netherlands",
...
"(UK),England,NorthernIreland,Scotland,Wales,FalklandIslands,Gibraltar,Guernsey,IsleofMan,Jersey,SaintHelena,Ascension,SouthGeorgia,theSouthSandwichIslands,TristandaCunha",
...
"Mayen,QueenMaudLand,PeterIIsland",
...
"VirginIslands,BritishIndianOceanTerritory,BritishVirginIslands,Ecuador,ElSalvador,Guam,Haiti,Micronesia,NorthernMarianaIslands,Palau,Panama,PuertoRico,Turks,CaicosIslands,UnitedStatesMinorOutlyingIslands,WakeIsland,EastTimor",
...
"Africaine,(BEAC),CFAFrancBEAC,Cameroon,CentralAfricanRepublic,Chad,Congo/Brazzaville,EquatorialGuinea,Gabon",
 "XAG : Silver Ounce,Silver",
 "XAU : Gold Ounce,Gold",
 "XCD : East Caribbean Dollar,East Caribbean Dollar,Anguilla,Antigua",
"Barbuda,Dominica,Grenada,TheGrenadines,SaintVincent,Montserrat",
...
"Franc,Benin,BurkinaFaso,IvoryCoast,GuineaBissau,Mali,Niger,Senegal,Togo",
 "XPF : CFP Franc,Comptoirs Fran&#231;ais du Pacifique (CFP)",
"Franc,FrenchPolynesia,NewCaledonia,Wallis,FutunaIslands",
...
def function1():
 ...
 if query == "Q":
  ...
  function1()
   ...
   print(fx["{qty} of currency {fromC} amounts to {amount} of currency {toC} today"])
try:
   function1()
except KeyError:
